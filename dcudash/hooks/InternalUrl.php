...
class dcudash_hook_InternalUrl extends _HOOK_CLASS_
{
	/**
	...
	public function correctFriendlyUrl()
	{
		...
		/* If it it thinks it belongs to "Dashes", we might be able to be more accurate */
		if ( $return instanceof \IPS\Http\Url\Friendly and $return->seoTemplate === 'content_dash_path' and isset( $this->queryString['path'] ) )
		{
			/* Try to find a dash */
			try
			{
				/* Create it */
				$correctUrl = \IPS\dcudash\Dashes\Router::loadFromUrl( $this )->url();			
