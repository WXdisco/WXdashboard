...
( function () {
	...
	var initialize = function () {
		...
		// We need to find the IPS widgets on the dash
	...
	/**
	 * Creates a widget in the dash, replacing the element in the param
	 *
	 ...
	 *
	 * @param	{number} 	[dashNo]	Dash number to load
	 * @returns {void}
	 */
	...
	var utils = {
		/*
		 * Cross-browser 'dom ready' event handler to init the dash
		 */
